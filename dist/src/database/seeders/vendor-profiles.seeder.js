...
exports.seedVendorProfiles = seedVendorProfiles;
...
const vendorsData = [
    {
        ...
        businessDescription: 'The finest artisan pizzas and burgers in town. Fresh ingredients, authentic recipes.',
    ...
    },
    {
        ...
        businessDescription: 'Premium burgers crafted with love. Juicy patties, fresh toppings, unforgettable taste.',
...
async function seedVendorProfiles(dataSource, users) {
    const vendorProfileRepo = dataSource.getRepository(vendor_profile_entity_1.VendorProfile);
    ...
    for (const vendorData of vendorsData) {
        ...
        if (!profile) {
            ...
            profile = vendorProfileRepo.create({
                ...profileData,
                userId: user.id,
                status: vendor_profile_entity_1.VendorStatus.APPROVED,
                approvedAt: new Date(),
    ...
    console.log(`🏪 Vendor profiles seeding complete (${seededProfiles.length} profiles)\n`);
    return seededProfiles;
}
//# sourceMappingURL=vendor-profiles.seeder.js.map