...
exports.orderStatusUpdateHtml = orderStatusUpdateHtml;
exports.orderStatusUpdateSubject = orderStatusUpdateSubject;
...
function orderStatusUpdateHtml(data) {
...
function orderStatusUpdateSubject(orderNumber, status) {
    const subjects = {
