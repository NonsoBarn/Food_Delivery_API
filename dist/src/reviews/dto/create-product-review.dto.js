...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 5, minimum: 1, maximum: 5, description: 'Star rating (1–5)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Really delicious, would order again!', maxLength: 1000 }),
